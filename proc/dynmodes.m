function [wmodes,pmodes,eigen,ce]=dynmodes(Nsq,p,nmodes)
...
% Add surface pressure with top Nsq value
    ...
    z=-p; % Set up depth array
    N2=Nsq;
    nz=n;
end

% Start making del-squared matrix 
...
% Create del-squared matrix plus boundary conditions
for i=2:nz-1
